...
<style type="text/css">
#myFocus{ width:811px; height:326px;margin:0;}
#myFocus2{ width:190px; height:400px;margin:0;position:relative;}
</style>
</head>
<body>
<div class="headerBar">
...
<!-- 	</div> -->
<!-- </div> -->
<div id="myFocus" class="banner comWidth clearfix"><!--焦点图盒子-->
  <div class="loading"><img src="plugins/myfocus/img/loading.gif" alt="请稍候..." /></div><!--载入画面(可删除)-->
  <div class="pic banner_bar banner_big"><!--图片列表-->
  	<ul class="imgBox">
        <li><a href="#1"><img src="images/banner/banner_01.jpg" thumb="" alt="图片1来源于网络，版权属于作者" text="图片1更详细的描述文字" /></a></li>
	   <li><a href="#2"><img src="images/banner/banner_02.jpg" thumb="" alt="图片5来源于网络，版权属于作者" text="图片5更详细的描述文字" /></a></li>
	    <li><a href="#1"><img src="images/banner/banner_01.jpg" thumb="" alt="图片1来源于网络，版权属于作者" text="图片1更详细的描述文字" /></a></li>
	   <li><a href="#2"><img src="images/banner/banner_02.jpg" thumb="" alt="图片5来源于网络，版权属于作者" text="图片5更详细的描述文字" /></a></li>
	    <li><a href="#1"><img src="images/banner/banner_01.jpg" thumb="" alt="图片1来源于网络，版权属于作者" text="图片1更详细的描述文字" /></a></li>
	   <li><a href="#2"><img src="images/banner/banner_02.jpg" thumb="" alt="图片5来源于网络，版权属于作者" text="图片5更详细的描述文字" /></a></li>
...
<div class="shopList comWidth clearfix">
	<div id="myFocus2" class="leftArea">
		<div class="loading"><img src="plugins/myfocus/img/loading.gif" alt="请稍候..." /></div><!--载入画面(可删除)-->
		<div class="pic banner_bar banner_sm">
			<ul class="imgBox">
				<li><a href="#1"><img src="images/banner/banner_sm_01.jpg" alt="banner"></a></li>
				<li><a href="#2"><img src="images/banner/banner_sm_02.jpg" alt="banner"></a></li>
			</ul>
<!-- 			<div class="imgNum"> -->
<!-- 				<a href="#" class="active"></a><a href="#"></a><a href="#"></a><a href="#"></a> -->
<!-- 			</div> -->
